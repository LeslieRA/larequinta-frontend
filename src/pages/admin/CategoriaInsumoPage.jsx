...
import { getCategoriasInsumo, createCategoriaInsumo, updateCategoriaInsumo, deleteCategoriaInsumo } from '../../api/categoriaInsumo.js'

const COLUMNS = [
  { key: 'idCatInsumo', label: 'ID'          },
...
export default function CategoriaInsumoPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setFormError(null)
      if (editing) {
        await updateCategoriaInsumo(editing.idCatInsumo, form)
      } else {
        await createCategoriaInsumo(form)
      }
      setModalOpen(false)
  ...
  async function confirmDelete() {
    try {
      await deleteCategoriaInsumo(toDelete.idCatInsumo)
  ...
  return (
    <div>
      <PageHeader title="Categorías de Insumos" subtitle="Agrupa los insumos por tipo" onNew={handleNew} />
      ...
      <Modal open={modalOpen} title={editing ? 'Editar Categoría' : 'Nueva Categoría de Insumo'} onClose={() => setModalOpen(false)}>
        <div className="form-grid">
          <div className="form-field form-field-full">
            <label>Nombre *</label>
            <input type="text" value={form.nombre}
              onChange={e => setForm({ ...form, nombre: e.target.value })}
              placeholder="Ej: Decoración, Equipo..." />
          </div>
          <div className="form-field form-field-full">
